            ...
            fetch(`https://api.bigdatacloud.net/data/country-info?code=${country1}&localityLanguage=en&key=7a3695bd3856499da3379e2c9dad63fb`)
                ...
                .then(countryData => {
                    ...
                    let flag = countryData.countryFlagEmoji
                        ...
                        document.querySelector('h3').innerText = `Origin ${flag}`
                        document.querySelector('p').innerText = `The national origin of a person with the name ${name} is likely ${country1} or ${country2}! If you live in ${country1}, you live on the continent of ${continent}, use the currency ${currency}, likely speak ${language}, and your country is considered a "${income}" country.`
                })
